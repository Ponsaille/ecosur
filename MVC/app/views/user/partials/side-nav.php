<aside id="side-nav">
    ...
    <nav>
        <ul>
            <li><a href="../users.view.php"><i class="fas fa-cogs fa-fw"></i> <span class="side-nav-text">Capteur/Actionneur</span></a></li>
    ...
    <span><a href=""><i class="fas fa-sign-out-alt fa-fw"></i> <span class="side-nav-text">Logout</span></a></span>
</aside>
